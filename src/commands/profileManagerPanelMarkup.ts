...
export function buildProfileManagerPanelBodyMarkup(
  ...
  <div class="shell">
    ...
    <div class="toolbar">
      ...
      <button class="btn primary" id="addProfileButton">${escapeHtml(i18n.addProfileAction)}</button>
    </div>
    ...
    <section class="empty" id="emptyState">
      ...
      <button class="btn primary" id="emptyStateAddButton">${escapeHtml(i18n.addProfileAction)}</button>
    </section>
  ...
  <div class="overlay" id="formModal" aria-hidden="true">
    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="formTitle">
      <button class="close" id="closeButton" type="button" aria-label="${escapeHtml(i18n.closeAction)}">×</button>
      ...
      <div class="modal-grid">
        <section class="pane pane-providers">
          <div class="section-label">${escapeHtml(i18n.provider)}</div>
          <div class="hint">${escapeHtml(i18n.providerSelectionHint)}</div>
          <div class="providers" id="providerPicker"></div>
        </section>

        <section class="pane pane-form">
          <div class="section-label">${escapeHtml(i18n.connectionDetailsSectionTitle)}</div>
